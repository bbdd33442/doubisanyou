...
public class TeaGeneral extends Fragment {
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		 ...
		 * Auto-generated method stub System.out.println(result);
		 * x.setText(result+"3"); } }, new FailCallBack() {
		 * 
		 * @Override public void onFail() { // TODO Auto-generated method stub
		 * 
		 * } }, "xx:1");
		 */
