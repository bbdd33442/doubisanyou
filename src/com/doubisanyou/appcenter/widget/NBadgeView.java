...
public class NBadgeView extends TextView {

    private boolean mHideOnNull = true;

    public NBadgeView(Context context) {
        this(context, null);
    }

    public NBadgeView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public NBadgeView(Context context, AttributeSet attrs, int defStyle) {
